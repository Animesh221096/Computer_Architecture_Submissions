...
public class Processor {
	...
	public Processor() {
		...
		L1i_cache = new Cache(this,
				configuration.Configuration.L1i_numberOfLines,
				configuration.Configuration.L1i_latency);
		...
		L1d_cache = new Cache(this,
				configuration.Configuration.L1d_numberOfLines,
				configuration.Configuration.L1d_latency);
		...
		configuration.Configuration.L1i_latency = 4;
